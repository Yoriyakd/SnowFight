...
Ground::Ground()
{
	...
	tex = resourceManager->GetTexture("Map/SnowGroundBig.png", 4096, 4096, NULL);
}
...
void Ground::Draw()
{
	...
	lpD3DDevice->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, 2, ground, sizeof(VERTEX));//(‚Â‚È‚¬•û, ƒ|ƒŠƒSƒ“•`‰æ”, ‰½‚©)
}
